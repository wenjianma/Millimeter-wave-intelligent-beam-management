...
#读入数据
y_move = pd.read_table('A_z_move.txt',header = None)
...
checkpoint_save_path = "./checkpoint_a_z_delay/LSTM_x.ckpt"
...
file = open('./A_predict_z_weights_z_delay.txt', 'w')  # 参数提取
...
# 画出真实数据和预测数据的对比曲线
file = open('./A_z_pre_delay_2.txt', 'w')  # 参数提取
