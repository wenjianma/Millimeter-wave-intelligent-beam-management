...
#读入数据
y_move = pd.read_table('B_z_move.txt',header = None)
...
checkpoint_save_path = "./checkpoint_b_z_delay/LSTM_x.ckpt"
...
file = open('./B_predict_z_weights_z_delay.txt', 'w')  # 参数提取
...
# 画出真实数据和预测数据的对比曲线
file = open('./B_z_pre_delay.txt', 'w')  # 参数提取
